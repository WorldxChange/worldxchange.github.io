...
export default makePageStream([
  ...
  },
  {
    ...
    data: {
      ...
      header: "Transparency",
      text: 'Carbon offset markets have been subject to occasional corruption. Some offset promises have been specious, "certification" agencies have incentives to generate revenue through high certification fees (encouraging enterprises that prioritize profits) and the sale of "certified" credits, and so on, all of which have the potential for greenwashing. Market prices for offsets (presumably a homogenous good!), can range from under $1 to over $100 per tonne of CO2e at any given time, depending on market conditions and the perceived quality of the offsets.',
    },
  },
  {
    component: WrappedTextHeader,
    data: {
      ...
      header: "Quality",
      text: "The Bali Project relies on **world-class science and technology** to establish emission levels and monitor, verify, and report the WINs generated by our stewards.  Thus, the resulting offsets are of high quality, going beyond the existing standards across all dimensions.  Given the early state of the project, we are offering our initial tranche of **offsets at $25 per tCO2e.** While this price is likely modest, it will allow us to get the project moving quickly so we can start to help the farmers.",
    },
  },
  {
    component: WrappedTextHeader,
  ...
  },
  {
    ...
    data: {
      ...
      text: "There are activities in our lives that impose costs or benefits on others that we fail to recognize—such activities lead to unfortunate choices. For example, dropping litter saves one some time and effort, yet everyone who follows is harmed and, alas, none of these people want to expend the effort needed to clean it up, even thought it would benefit everyone in the future.  **Releasing CO2e into the atmosphere is littering at a global scale.**",
    },
  },
  {
    component: WrappedTextHeader,
