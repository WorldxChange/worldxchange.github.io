...
export default makePageStream([
  ...
  },
  {
    ...
    data: {
      ...
      header: "Quality",
      text: "The Bali Project relies on **world-class science and technology** to establish emission levels and monitor, verify, and report the WINs generated by our stewards.  Thus, the resulting offsets are of high quality.  Given the early state of the project, we are offering our initial tranche of **offsets at $25 per tCO2e.** While this price is likely modest, it will allow us to get the project moving quickly so we can start to help the farmers.",
    },
  },
  {
    component: WrappedTextHeader,
